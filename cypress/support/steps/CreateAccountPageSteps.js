...
class CreateAccountPageSteps {
    ...
    verifyingTheErrorMessageForInvalidName () {
        pm.createAccountPage
            .getNameField()
            .should( 'have.css', 'border-color', 'rgb(220, 53, 69)' );
    ...
    verifyingTheErrorMessageForInvalidLastName () {
        pm.createAccountPage
            .getLastNameField()
            .should( 'have.css', 'border-color', 'rgb(220, 53, 69)' );
    ...
    enterUserInfoInfoWithInvalidName () {
        pm.createAccountPage.getSignUpButton().click();
        pm.createAccountPage
            .getNameField()
            .type( registrationData.invalidFirstName.trim() );
        pm.createAccountPage
            .getLastNameField()
            .type( registrationData.lastName.trim() );
    }

    enterUserInfoInfoWithInvalidLastName () {
        pm.createAccountPage.getSignUpButton().click();
        pm.createAccountPage
            .getNameField()
            .type( registrationData.firstName.trim() );
        pm.createAccountPage
            .getLastNameField()
            .type( registrationData.invalidLastName.trim() );
        pm.createAccountPage
            .getEmailField()
